...
| APP_ANPC_STATE_ADV           | Green LED flashes once every 3 seconds. (On: 50 ms, Off: 2950 ms)       |
| APP_ANPC_STATE_WITH_BOND_ADV | Green LED flashes twice every 3 seconds. (On: 50 ms, Off: 50 ms)        |
| APP_ANPC_STATE_CONN          | Green LED flashes twice every 1.5 seconds. (On: 50 ms, Off: 150 ms)     |
...
21. On the ANPC device, it enters the APP_ANPC_STATE_CONN state, indicating that a connection has been established with the ANPS device 2.
