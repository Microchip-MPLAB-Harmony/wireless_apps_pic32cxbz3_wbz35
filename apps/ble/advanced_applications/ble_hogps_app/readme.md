...
|The timeout of advertising with bonding | timeout_with_bond_adv | 30 seconds |
...
- **APP_HOGPS_STATE_WITH_BOND_ADV**: The application is waiting for reconnection for timeout_with_bond_adv seconds.
...
| **APP_HOGPS_STATE_WITH_BOND_ADV** | Long press Button 1 | Start a new pairing |
...
| APP_HOGPS_STATE_WITH_BOND_ADV      | Green LED flashes two time every 3 seconds. (On: 50 ms, Off: 50 ms)     |
...
14. On the curiosity board, plug USB cable to it to turn on the power.
    - The curiosity board will enter **APP_HOGPS_STATE_WITH_BOND_ADV** and wait for reconnecting for timeout_with_bond_adv seconds.
