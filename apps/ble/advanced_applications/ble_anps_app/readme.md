...
| APP_ANPS_STATE_SCAN           | Green LED flashes once every 3 seconds. (On: 50 ms, Off: 2950 ms)       | 
| APP_ANPS_STATE_WITH_BOND_SCAN | Green LED flashes twice every 3 seconds. (On: 50 ms, Off: 50 ms)        | 
| APP_ANPS_STATE_CONNECTED      | Green LED flashes twice every 1.5 seconds. (On: 50 ms, Off: 150 ms)     | 
