#merged modified on img_src_addr
import struct
...
#   boot flash or embedded flash: 0 or 1
#   RAM: Not applicable
global_slot_num=0

# device family available:
# 0 - Chimera V2
# 1 - Buckland A0 V1
# 2 - Buckland A1 V3/140bits
# 3 - BigBuck V3/274bits
g_device_family=1
...
def header_copyright():
    print("Header GUI v1.12b (c) 11/17/2022 Microchip Technology All Rights Reserved")
    
def ota_copyright():
    print("Over The Air Package Maker GUI v1.09 (c) 12/15/2022 Microchip Technology All Rights Reserved")
...
def memory_addr_set():
    ...
    if global_flash_type == 0:
        ...
        if global_slot_num == 0:
            ...
            if g_device_family == 1 or g_device_family == 2: #Buckland
                global_header_start_address=0x802800
                global_crop_start_address=0x802A00
                g_img_src_addr=0x802A00
                g_img_dst_addr=0x802A00
            elif g_device_family == 3:
                global_header_start_address=0x807800
                global_crop_start_address=0x807A00
                g_img_src_addr=0x807A00
                g_img_dst_addr=0x807A00
        else:
        ...
        if g_device_family < 3:
            ...
            global_crop_end_address = 0x1080000 #0x1200000
        else:
...
#    elif "BZ6" in device:
#        g_device_family = 3
    print('device family is ' + str(g_device_family))
...
class OTAPane():
    ...
    def initUI(self):
        ...
        if( g_device_family == 0 ):
            self.OTAPath_items = ("Internal Flash DFU")
        elif( g_device_family == 3 ):
...
def fill_chimera_header():
    ...
    filler_338 = bytearray(b'\x00')*338
    g_metaheader[113:439] = filler_338
