...
-   **Refer the coap_sed_server Applications document link (https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=BZ3_COAP&version=latest&redirect=true)**